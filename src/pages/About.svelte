      ...
      >
        ...
        >
          <p class="first-letter:text-4xl first-letter:font-bold">
            What's up? I'm Mourya, a Student at IIIT Hyderabad with expertise in web
            development and AI/ML. Currently, I am pursuing MSIT Program at
            IIIT Hyderabad.
          </p>
          <p class="indent-4">
          ...
          <p class="indent-4">
            My expertise include Pytorch, Scikit-Learn, Pandas. Recently I
            have been intrigue with the architecture behind GPT. Aside from coding,
            I enjoy playing badminton, video games and anime.
          </p>
        </div>
        <!-- <Link
				data-aos="fade-left"
