      ...
      >
        ...
        >
          <p class="first-letter:text-4xl first-letter:font-bold">
            What's up? I'm Mourya, a graduate from IIT Roorkee and IIT Madras. I am
            currently pursuing MSIT Program from IIIT Hyderabad.
          </p>
          <p class="indent-4">
            My passion is to create full stack applications powered by AI. I strive
            to build quality, clean, intuitive, and robust software with
            attention and deliberation.
          </p>
          <p class="indent-4">
            My expertise include Python, ML Stack such as Numpy, Pandas, Plotly, Pytorch and scikit-learn. 
            Aside from coding, I enjoy playing badminton, video games, and watching tv shows.
          </p>
        </div>
      </div>
    </div>
