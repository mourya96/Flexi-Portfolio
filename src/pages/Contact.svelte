<script>
  ...
  async function submitForm() {
    ...
    if (res.ok) {
      ...
      alert(
        "Uh oh... message failed to send. You can email me directly at mouryanagesh96@gmail.com"
      );
    }
  }
</script>
        ...
        <div class="basis-2/5">
          ...
          <h5 data-aos="fade" class="text-gray-500 dark:text-gray-300 mb-7">
            ...
            <button
              ...
              on:click={() => copyToClipboard("mouryanagesh96@gmail.com")}
              >mouryanagesh96@gmail.com</button
            >
            and
            <button
              class="text-gray-700 dark:text-gray-100 underline"
              on:click={() => copyToClipboard("mouryanagesh96@msitprogram.net")}
              >mouryanagesh96@msitprogram.net</button
            >
          </h5>
        </div>
